...
class Config(object):
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'https://mysql+pymysql://ssmorderntech@gmail.com:saksham123#4@mariadb105-cfa1.euw2.cloud.ametnes.com'  # needed for any database modules
