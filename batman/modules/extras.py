...
def table(bot: Bot, update: Update):
            ...
            if r <= 45:
                ...
                update.message.reply_text("Send money to buy new table to flip")
            else:
                update.message.reply_text("Go do some work instead of flipping tables you helpless fagit.")
...
__help__ = """
 ...
 !(It have abuse strings don't use for child, use it on your risk.)
 !(Anyone get abuse with string and fell it is not for fun report us on @DragonAssociationSupport)
