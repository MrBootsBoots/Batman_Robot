...
import batman.modules.sql.connection_sql as sql
from batman import dispatcher, LOGGER, SUDO_USERS
from batman.modules.helper_funcs.chat_status import bot_admin, user_admin, is_user_admin, can_restrict
from batman.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from batman.modules.helper_funcs.string_handling import extract_time

# from batman.modules.translations.strings import tld

from batman.modules.keyboard import keyboard
